...
class Transporter {
    ...
    render() {
        //========= Caustic Rendering =========//
        // Compute densities using displacements
        ...
        // Render caustics using densities
        ...
        // Subtract current caustic pattern from target
        ...
        // Solve poisson equation on difference
        this.poisson_solver.solve(this.f_difference, this.f_tempB);
        
        // Find gradient of solution
        ...
        // Calculate flow vectors from solution gradient & displacements
        ...
        //========= Approximate Helmholtz Decomposition =========//
        // TODO: Just use the heightmap instead? Or correct whole thing, fix scaling, etc.

        // Find divergence of flow field
        filterTo(this.f_divergence,
            this.divergence_shader,
            {map: this.f_flow},
            {resolution: this.resolution}
        );
        // Solve Poisson equation using divergence
        this.poisson_solver.solve_coarse_priority(this.f_divergence, this.f_heightmap);
        // The gradient of the solution is the same field, but curl-free
